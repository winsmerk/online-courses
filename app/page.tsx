    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="shell hero-grid">
          <div className="hero-copy">
            ...
            <h1>把经验变成方法，把学习变成能力。</h1>
            <p>
              与真正做过、想清楚、讲明白的人一起学习。用系统课程跨过试错，
              建立属于自己的专业路径。
            </p>
          ...
          <div className="hero-collage" aria-label="讲师与课程">
            <div className="portrait-card card-a">
              ...
              />
              <div>
                <strong>把专业沉淀成长期影响力</strong>
                <small>林知遥 · 品牌策略</small>
              </div>
            </div>
            <div className="portrait-card card-b">
              ...
              />
              <div>
                <strong>让 AI 成为可靠的工作伙伴</strong>
                <small>周原 · AI 工作流</small>
              </div>
            </div>
        ...
        <div className="shell">
          <div className="section-heading">
            <div>
              ...
              <h2>按自己的节奏，完成有结构的学习。</h2>
            </div>
          </div>
          <div className="feature-grid">
            {[
              ["01", "看得懂", "每个复杂主题都被拆成清晰章节，并配合真实案例讲解。"],
              ["02", "做得出", "课程附件、行动清单与练习，帮助知识真正进入工作。"],
              ["03", "看得到", "自动记录学习进度，清楚知道待学习、学习中与已完成。"],
      ...
      <section className="section" id="enroll">
        <div className="shell wechat-cta">
          ...
          <div className="qr-placeholder">官方微信二维码</div>
        </div>
      </section>
      <Footer />
    </>
